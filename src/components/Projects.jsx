...
function Projects() {
  ...
  // Memoize ProjectCard component to prevent unnecessary re-renders
  const ProjectCard = useCallback(
    ({ project }) => (
      <div className="project-card group relative bg-gray-900 rounded-xl overflow-hidden border border-gray-800 hover:border-violet-500/50 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl hover:shadow-violet-500/10">
        {/* Featured Badge */}
        {project.featured && (
        ...
        <div className="relative h-32 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center justify-center space-x-3">
            <a
              ...
              className="flex items-center space-x-1 bg-violet-600 hover:bg-violet-700 px-3 py-1.5 rounded-full text-white text-sm font-medium transition-colors duration-200"
            >
              <FaPlay size={10} />
              <span>Live</span>
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center space-x-1 bg-gray-800 hover:bg-gray-700 px-3 py-1.5 rounded-full text-white text-sm font-medium transition-colors duration-200"
            >
              <FaCode size={10} />
              <span>Code</span>
            </a>
        ...
        {/* Project Content */}
        <div className="p-4">
          <h3 className="text-lg font-bold text-white mb-2 group-hover:text-violet-400 transition-colors duration-200">
            {project.title}
          </h3>
  ...
  return (
    <section id="projects" className="bg-black py-16">
      <div className="max-w-6xl mx-auto px-4">
        ...
        {/* Projects Grid */}
        <div className="projects-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
